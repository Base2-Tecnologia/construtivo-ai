...
-- Período: 16/05/2026 a 26/05/2026 (últimos 10 dias)
--
-- Ordem de aplicação (respeita dependências entre tabelas):
--   1.  Pedido de Compra via Portal do Fornecedor     (16/05)
--   2.  Cadastro de Insumos                           (19/05)
--   3.  UAU: código da empresa em empresas            (21/05)
--   4.  UAU: CAP no cadastro de insumos               (21/05)
--   5.  UAU: vínculos de planejamento por contrato    (21/05)
--   6.  UAU: número do pedido em req_materiais        (21/05)
--   7.  VIEW v_contrato_progresso                     (23/05)
--   8.  UAU: código do fornecedor em fornecedores     (23/05)
--   9.  Fornecedor: e-mails_copia (CC)                (23/05)
--
...
--
-- Como aplicar:
--   cat db/migrate_ultimos_10_dias_20260526.sql | docker compose exec -T construtivo-db psql -U construtivo -d construtivo_obras
-- ================================================================
...
-- ================================================================
-- 3. UAU: código da empresa na tabela empresas          (21/05)
-- ================================================================
...
-- ================================================================
-- 4. UAU: CAP (Conta de Apropriação) no cadastro de insumos (21/05)
-- ================================================================
...
-- ================================================================
-- 5. UAU: vínculos de planejamento (SI) por contrato    (21/05)
-- ================================================================
...
-- ================================================================
-- 6. UAU: número do pedido de compra em req_materiais   (21/05)
-- ================================================================
...
-- ================================================================
-- 9. Fornecedor: e-mails adicionais em cópia (CC)       (23/05)
-- ================================================================
...
-- FIM
-- ================================================================
SELECT 'Migração 16-26/05/2026 aplicada com sucesso.' AS resultado;
