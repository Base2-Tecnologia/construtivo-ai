-- ================================================================
-- CONSTRUTIVO OBRAS — Script de Migração Consolidado
-- Período: 07/05/2026 a 20/05/2026 (últimas 2 semanas)
--
-- Ordem de aplicação (respeita dependências entre tabelas):
--   1. RDC (Requisição de Compra)           07/05/2026
--   2. RDC Anexos                           07/05/2026
--   3. Requisição de Material (Canteiro)    13/05/2026
--   4. Requisição de Material v2 (itens)    13/05/2026
--   5. Integração UAU (ERP)                 13/05/2026
--   6. Pedido de Compra via Portal          16/05/2026
--   7. Cadastro de Insumos                  19/05/2026
--
-- Como aplicar:
--   cat db/migrate_consolidado_20260520.sql | docker compose exec -T construtivo-db psql -U construtivo -d construtivo_obras
-- ================================================================


-- ================================================================
-- 1. RDC — Requisição de Compra (Módulo Suprimentos)
-- Criado em: 07/05/2026
-- ================================================================
...
CREATE TABLE IF NOT EXISTS rdcs (
  ...
  -- Status: rascunho → aguardando_aprovacao → aprovada → em_processo → contratada | cancelada
...
CREATE TABLE IF NOT EXISTS req_materiais (
  ...
  -- Status: pendente → aprovado | reprovado → em_compra → entregue | cancelado
...
-- ================================================================
-- 5. Integração UAU (ERP Senior/Globaltec)
-- Criado em: 13/05/2026
-- ================================================================
...
-- Configuração global UAU (usa tabela configuracoes existente)
...
-- Habilita funcionalidade no painel de configurações (desativada por padrão)
...
-- FIM DO SCRIPT
-- ================================================================
SELECT 'Migração consolidada 20260520 aplicada com sucesso.' AS resultado;
